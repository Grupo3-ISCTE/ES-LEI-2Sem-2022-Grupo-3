...
public class AttrStringUtils {
    ...
    private static float[] deriveTextBoundsAnchorOffsets(Graphics2D g2,
        ...
        result[0] = xAdjText(anchor, bounds);
        result[1] = yAdjText(anchor, textBounds, bounds, halfAscent, descent, leading);
        return result;
    }

    public static float yAdjText(TextAnchor anchor, Rectangle2D textBounds, Rectangle2D bounds, float halfAscent,
    ...
    public static float xAdjText(TextAnchor anchor, Rectangle2D bounds) {
        float xAdj = 0.0f;
    ...
    private static float[] deriveRotationAnchorOffsets(Graphics2D g2,
        ...
        result[0] = xAdj(anchor, bounds);
        result[1] = yAdj(anchor, bounds, halfAscent, descent, leading);
        return result;

    }

    public static float yAdj(TextAnchor anchor, Rectangle2D bounds, float halfAscent, float descent, float leading) {
        float yAdj = 0.0f;
    ...
    public static float xAdj(TextAnchor anchor, Rectangle2D bounds) {
        float xAdj = 0.0f;
